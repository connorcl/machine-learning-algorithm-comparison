...
deep_learning_timings <- read.csv("deep_learning_results.csv")
decision_tree_timings <- read.csv("decision_tree_results.csv")

# load timings of algorithms w/ noncontiguous data
deep_learning_timings_nc <- read.csv("deep_learning_results_nc.csv")
decision_tree_timings_nc <- read.csv("decision_tree_results_nc.csv")
